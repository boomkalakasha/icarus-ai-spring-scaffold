...
response to behavior they consider inappropriate, threatening, offensive, or
harmful.
...
Examples of representing the project include using an official project
account, posting through an official communication channel, or acting as an
appointed representative at an online or offline event.

## Reporting

Report unacceptable behavior to the project maintainers through a private
channel. Do not include security vulnerability details in a conduct report;
follow [SECURITY.md](SECURITY.md) for those reports. All reports will be
